...
describe('testing addition and multiplication regression', () => {
    ...
    test("Standalone * is invalid", 3, evaluate, SyntaxError, "*42");
    test("Multiplication is performed before addition", 4, evaluate, 42, "6*6+6");
    test("Multiplication is performed before addition - 2", 4, evaluate, 42, "7+5*7");
...
describe('testing subtraction and division', () => {
    ...
    test("Associativity can be overriden via parentheses", 3, evaluate, 3, "5+(2-4)+(3-1)");
